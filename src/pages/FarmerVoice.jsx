    ...
    return (
        <div className="relative">
            ...
            <div className="px-2 lg:px-4 xl:px-[25px] 2xl:px-[45px] 3xl:px-[50px]">
                ...
                <div className="py-8 2xl:py-16">
                    <img src="/assets/img/farmervoice/farmer_3.png" className="w-full" alt="Farmers Voice Image 3" />
                </div>
                <div>
                            ...
                            <div className="overflow-hidden md:border-r md:border-white">
                                <Link to="/works/newwaters">
                                    <div
                                        ...
                                        bg-[url('assets/img/farmervoice/newwaters_1.png')] md:bg-[url('assets/img/farmervoice/newwaters.png')]
                                        bg-no-repeat bg-cover transition duration-300 ease-in-out hover:scale-105"
                                    >
                                        <div className="font-bold text-[15px] lg:text-base xl:text-2xl">Newwaters</div>
