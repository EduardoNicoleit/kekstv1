            ...
            <div className="px-2 lg:px-4 xl:px-[25px] 2xl:px-[45px] 3xl:px-[50px]">
                ...
                <div className="py-8 2xl:py-16 flex">
                    ...
                    <div className="w-full">
                        <img src="/assets/img/newwaters/newwaters_1.png" className="w-full" alt="Newwaters Image 1" />
                    </div>
                </div>
                <div className="flex">
                    <div className="hidden lg:block lg:w-[299px] flex-none"></div>
                    <div className="w-full">
                        <img src="/assets/img/newwaters/newwaters_5.png" className="w-full" alt="Newwaters Image 2" />
                    </div>
                </div>
                <div className="py-8 2xl:py-16 flex">
                    <div className="hidden lg:block lg:w-[299px] flex-none"></div>
                    <div className="w-full">
                        <img src="/assets/img/newwaters/newwaters_2.png" className="w-full" alt="Newwaters Image 3" />
                    </div>
                </div>
                <div>
                    <img src="/assets/img/newwaters/newwaters_3.png" className="w-full" alt="Newwaters Image 4" />
                </div>
                <div className="py-8 2xl:py-16 flex">
                    <div className="hidden lg:block lg:w-[299px] flex-none"></div>
                    <div className="w-full h-full">
                        <img src="/assets/img/newwaters/newwaters_4.png" className="w-full h-full" alt="Newwaters Image 5" />
                    </div>
                </div>
                        ...
                        <div className="grid grid-cols-2 w-full">
                            ...
                            <div className="overflow-hidden md:border-r md:border-white">
                                <Link to="/works/uniper">
                                    ...
                                    >
                                        <div className="font-bold text-[15px] lg:text-base xl:text-2xl">Uniper</div>
                            ...
                            <div className="overflow-hidden">
                                <Link to="/works/farmerVoice">
                                    ...
                                    >
                                        <div className="font-bold text-[15px] lg:text-base xl:text-2xl">Farmer</div>
                                        <div className="flex-1">
                                            <div
                                                className="max-w-[440px] py-[26px] lg:py-[43px] xl:py-[67px] font-normal
                                                text-[12px] lg:text-[21px] xl:text-[32px] 2xl:text-[40px] leading-tight"
