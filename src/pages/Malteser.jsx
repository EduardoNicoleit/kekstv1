        ...
        <div className="relative">
            ...
            <div className="px-2 lg:px-4 xl:px-[25px] 2xl:px-[45px] 3xl:px-[45px]">
                ...
                <div className="py-8 2xl:py-16">
                    <img src="/assets/img/malteser/malteser_1.png" className="w-full" alt="Malteser Design Identity" />
                </div>
                <div className="pt-8 2xl:pt-16 pb-8 md:pb-0">
                    <img src="/assets/img/malteser/malteser_2.png" className="w-full" alt="Malteser Data Visualization" />
                </div>
                <div className="flex">
                    <div className="hidden lg:block lg:w-[299px] flex-none"></div>
                    <div className="w-full">
                        <img src="/assets/img/malteser/malteser_3.png" className="w-full" alt="Malteser Infographics" />
                    </div>
                </div>
                ...
                <div className="pt-8 2xl:pt-16 pb-8 md:pb-0">
                    <img src="/assets/img/malteser/malteser_4.png" className="w-full" alt="Malteser Communication Strategy" />
                </div>
                <div className="pb-8 2xl:pb-16 flex">
                    <div className="hidden lg:block lg:w-[299px] flex-none"></div>
                    <div className="w-full">
                        <img src="/assets/img/malteser/malteser_5.png" className="w-full" alt="Malteser Visual Narrative" />
                    </div>
                </div>
                        ...
                        <div className="grid grid-cols-2 w-full">
                            ...
                            <div className="overflow-hidden md:border-r md:border-white">
                                <Link to="/works/farmerVoice">
                                    <div
                                        ...
                                        bg-[url('assets/img/malteser/farmer_header_1.png')] md:bg-[url('assets/img/malteser/farmer_header.png')]
                                        bg-no-repeat bg-cover
                                        transition duration-300 ease-in-out hover:scale-105"
                                    >
                                        <div className="font-bold text-[15px] lg:text-base xl:text-2xl">Farmer Voice</div>
                            ...
                            <div className="overflow-hidden">
                                <Link to="/works/dtcp">
                                    <div
                                        className="cursor-pointer py-[26px] 2xl:py-[100px] px-[15px] md:px-10 flex flex-col h-full
                                        bg-[url('assets/img/malteser/dtcp_header_1.png')] md:bg-[url('assets/img/malteser/dtcp_header.png')]
                                        bg-no-repeat bg-cover
                                        transition duration-300 ease-in-out hover:scale-105"
                                    >
                                        <div className="font-bold text-[15px] lg:text-base xl:text-2xl">DTCP</div>
                                        <div className="flex-1">
                                            <div
                                                className="max-w-[440px] py-[26px] lg:py-[43px] xl:py-[67px] font-normal
                                                text-[12px] lg:text-[21px] xl:text-[32px] 2xl:text-[40px] leading-tight"
