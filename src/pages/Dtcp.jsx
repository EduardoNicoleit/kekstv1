    ...
    return (
        <div className="relative">
            ...
            <div className="px-2 lg:px-4 xl:px-[25px] 2xl:px-[45px] 3xl:px-[50px]">
                ...
                <div>
                    <img src="/assets/img/dtcp/dtcp_header1.png" className="w-full" alt="keskt..." />
                </div>
                <div className="pt-8 2xl:pt-16 pb-8 md:pb-0">
                    <img src="/assets/img/dtcp/dtcp_3.png" className="w-full" alt="keskt..." />
                </div>
                <div className="flex">
                    <div className="hidden lg:block lg:w-[299px] flex-none"></div>
                    <div className="w-full">
                        <img src="/assets/img/dtcp/dtcp_2.png" className="w-full" alt="keskt..." />
                    </div>
                </div>
                <div className="pt-8 2xl:pt-16 pb-8 md:pb-0">
                    <img src="/assets/img/dtcp/dtcp_1.png" className="w-full" alt="keskt..." />
                </div>
                ...
                <div className="flex text-white font-Helvetica">
                    <div className="grid grid-cols-2 w-full overflow-hidden">
                        ...
                        <div className="py-[26px] 2xl:py-[100px] px-[15px] md:px-10 flex flex-col h-full 
                        bg-[url('assets/img/dtcp/bp_1.png')] md:bg-[url('assets/img/dtcp/bp_3b.png')] bg-no-repeat bg-cover transition duration-300 ease-in-out hover:scale-105">
                            <div className="font-bold text-[15px] lg:text-base xl:text-2xl">
                                bp
                            </div>
                            <div className="flex-1">
