        ...
        <div className="">
            <div className="bg-[url('assets/img/home/process_bg.png')] bg-no-repeat bg-cover w-full text-white font-Helvetica px-2 lg:px-4 xl:px-[25px] 2xl:px-[45px] bottom-0 top-0">
                <div className="bottom-0 top-0 md:top-2 lg:top-3 xl:top-0 w-full">
                    ...
                    <div className="leading-normal font-normal text-[17px] md:text-[18px] lg:text-[22px] xl:text-[24px] 2xl:text-[32px] 3xl:text-[1.5vw] pl-5 md:pl-[34px] lg:pl-[59px] xl:pl-[100px] 2xl:pl-[308px] lg:pr-[100px] xl:pr-[140px] 3xl:pr-[10vw] font-Helvetica pb-8 md:pb-[58px] lg:pb-20 xl:pb-20 2xl:pb-[100px] py-6 xl:py-[60px] xl:py-[60px] 2xl:py-[60px]">
