        ...
        <div className="relative">
            ...
            <div className="relative text-white bg-cover bg-center w-full h-full" ref={element}>
                ...
                <div className="absolute bottom-0 top-4 w-full px-12 flex flex-col font-Arial">
                    <div className="font-Helvetica text-[30px] sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl 2xl:text-[130px] 3xl:text-[160px] font-bold sm:px-[300px] md:px-[300px] lg:px-[270px] xl:px-[308px] mt-auto sm:py-6 md:py-8 lg:py-10 xl:py-12 2xl:py-16 3xl:py-20">
                        Volkswagen
                    </div>
            ...
            <div className="pt-[128px] lg:pt-[280px] pl-[110px] pr-[264px] pb-[124px] flex relative">
                ...
                <div className=" w-[84%] text-white text-[40px] font-Helvetica font-normal leading-[46px] box-border">
