...
const ExpertiseFooter = () => {
    ...
    return (
        <div className="border-y-[1px] px-6 sm:px-6 flex flex-col py-8 sm:py-3 md:py-10 lg:py-12 2xl:py-[4vw] 3xl:py-[5vw] font-Helvetica text-base sm:text-lg md:text-xl lg:text-xl xl:text-2xl 2xl:text-[2.5vw] 3xl:text-[2vw]">
