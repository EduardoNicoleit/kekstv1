                ...
                <div className="flex">
                    ...
                    <div className="w-full">
                        ...
                        <div className="grid grid-cols-2">
                            <div className="sm:h-[500px] md:h-[650px] lg:h-[620px] 2xl:h-[680px] border-r-[1px] border-t-[1px] relative">
                                <div className="sm:p-8 md:p-10 lg:p-16 xl:p-20">
                                    <div className="sm:text-2xl md:text-3xl lg:text-3xl 2xl:text-4xl 3xl:text-[45px] ">
                                        STRATEGIC<br />INSIGHTS
                                    </div>
                                    <div className="sm:text-base md:text-xl lg:text-xl xl:text-2xl 2xl:text-3xl 3xl:text-[32px] py-[50px] 3xl:py-10 w-60 xl:w-full">
                                ...
                                <div className="text-[#9F81BF] w-16 h-16 font-Helvetica text-[34px] absolute bottom-0 top-[-24px] left-14 bg-[#210837] text-center">
                                    01
                                </div>
                            </div>
                            <div className="sm:h-[500px] md:h-[650px] lg:h-[620px] 2xl:h-[680px] border-t-[1px] relative">
                                <div className="sm:p-8 md:p-10 lg:p-16 xl:p-20">
                                    <div className="sm:text-2xl md:text-3xl lg:text-3xl 2xl:text-4xl 3xl:text-[45px]">
                                        DESIGN WITH
                                        <br />PURPOSE
                            ...
                            <div className="sm:h-[500px] md:h-[650px] lg:h-[620px] 2xl:h-[680px] border-r-[1px] border-t-[1px] relative">
                                <div className="sm:p-8 md:p-10 lg:p-16 xl:p-20">
                                    ...
                                    <div className="sm:text-base md:text-xl lg:text-xl xl:text-2xl 2xl:text-3xl 3xl:text-[32px] py-[50px] w-60 xl:w-full">
                            ...
                            <div className="sm:h-[500px] md:h-[650px] lg:h-[620px] 2xl:h-[680px] border-t-[1px] relative">
                                <div className="sm:p-8 md:p-10 lg:p-16 xl:p-20">
                                    ...
                                    <div className="sm:text-base md:text-xl lg:text-xl xl:text-2xl 2xl:text-3xl 3xl:text-[32px] py-[50px] 3xl:py-10 w-64 xl:w-full">
