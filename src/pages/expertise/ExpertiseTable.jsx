                        ...
                        <div className="grid grid-cols-2">
                            <div className="sm:h-[500px] md:h-[550px] lg:h-[550px] 2xl:h-[550px] 3xl:h-[25vw] border-r-[1px] border-t-[1px] relative">
                                <div className="sm:p-8 md:p-10 lg:p-12 xl:p-16 3xl:p-[3vw]">
                                    ...
                                    <div className="text-sm sm:text-sm lg:text-lg xl:text-xl 2xl:text-[20px] 3xl:text-[1.05vw] py-[50px] 3xl:py-[2vw] leading-normal 3xl:leading-[1.6vw] w-full xl:w-full">
