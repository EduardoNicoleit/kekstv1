...
const ExpertiseTableCompo = () => {
    return (
        <div className="text-white font-Helvetica">
            <div className="border-t-[1px] border-white">
                <div className="flex">
                    <div className="hidden lg:block flex-none lg:w-[46px] xl:w-[154px] 2xl:w-[308px] 3xl:w-[15vw] border-r-[1px] border-white">
                    </div>
                    <div className="w-full">
                        <div className="md:h-20 lg:h-60 3xl:h-[10vw]"></div>
                        <div className="grid grid-cols-2">
                            <div className="sm:h-[500px] md:h-[650px] lg:h-[620px] 2xl:h-[680px] 3xl:h-[25vw] border-r-[1px] border-t-[1px] relative">
                                <div className="sm:p-8 md:p-10 lg:p-16 xl:p-20 3xl:p-[3vw]">
                                ...
                                <div className="text-[#9F81BF] w-16 h-16 3xl:w-[4vw] 3xl:h-[4vw] font-Helvetica text-[34px] 2xl:text-[2vw] 3xl:text-[1.5vw] absolute bottom-0 top-[-24px] 2xl:top-[-2vw] left-14 2xl:left-[3vw] bg-[#210837] text-center flex items-center justify-center">
                                    01
                                </div>

                            </div>
                            <div className="sm:h-[500px] md:h-[650px] lg:h-[620px] 2xl:h-[680px] 3xl:h-[25vw] border-t-[1px] relative">
                                <div className="sm:p-8 md:p-10 lg:p-16 xl:p-20 3xl:p-[3vw]">
                                    <div className="sm:text-2xl md:text-3xl lg:text-3xl 2xl:text-4xl 3xl:text-[2.2vw] 5xl:text-[2vw] 3xl:leading-[2.5vw]">
                            ...
                            <div className="sm:h-[500px] md:h-[650px] lg:h-[620px] 2xl:h-[680px] 3xl:h-[30vw] border-r-[1px] border-t-[1px] relative">
                                <div className="sm:p-8 md:p-10 lg:p-16 xl:p-20 3xl:p-[3vw]">
                                    <div className="sm:text-2xl md:text-3xl lg:text-3xl 2xl:text-4xl 3xl:text-[2.2vw] 5xl:text-[2vw] 3xl:leading-[2.5vw]">
                            ...
                            <div className="sm:h-[500px] md:h-[650px] lg:h-[620px] 2xl:h-[680px] 3xl:h-[30vw] border-t-[1px] relative">
                                <div className="sm:p-8 md:p-10 lg:p-16 xl:p-20 3xl:p-[3vw]">
                                    <div className="sm:text-2xl md:text-3xl lg:text-3xl 2xl:text-4xl 3xl:text-[2.2vw] 5xl:text-[2vw] 3xl:leading-[2.5vw]">
...
export default ExpertiseTableCompo;
