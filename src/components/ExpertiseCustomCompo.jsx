...
const ExpertiseCustomCompo = ({ isSticky, element, img, mainText1, mainText2, expertiseTableData, expertiseData }) => {
    return (
        <div>
            <div className="px-2 pt-2">
                <div className="border-x-[1px] border-t-[1px] border-white">
                    <Navbar sticky={isSticky} />
                    <div className="relative text-white welcome">
                        <img src={img} alt="" className="w-full" ref={element} />
                        <div className="px-[11px] w-full absolute bottom-0">
                            <div className="flex flex-col ">
                                <div className="font-Helvetica text-[30px] py-[56px]">
                    ...
                    <div className="">
                        <div className="border-white py-[42px] font-Helvetica text-white">
                            <div className="pl-6">
                                <div className="text-xs font-normal pb-2">Ours Services</div>
                                <div className="">
                                    {expertiseData.map((data, index) => (
                                        <div key={index} className="border-b-[1px] flex flex-row border-white items-center py-3">
                            ...
                            <div className="border-t-[1px] border-white">
                                {expertiseTableData.map((data) => (
                                    <div key={data.id} className="font-Helvetica py-6 pl-6">
                                        ...
                                        <div className="font-normal text-[21px] pb-4">
                                            {data.mainText1} <br /> {data.mainText2}
                                        </div>
                                        <div className="font-normal text-[17px] pr-5">
                                            {data.content}
                                        </div>
                                    </div>
                                ))}
