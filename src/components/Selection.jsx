    ...
    return (
        <div>
            {selectionsData && selectionsData.map((data, index) => (
                <div key={data.id} className={`flex flex-col md:flex-row text-white sm:px-0 md:px-0  ${data.id !== 1 ? ' pt-6 lg:pt-8 xl:pt-[60px] 2xl:pt-8' : ' md:mt-[-40px] lg:mt-[-20px] xl:mt-0 '}`}>
                    ...
                    <div className='flex-1 m-0 p-0 border-white border-b-[1px]'>
                        ...
                        py-8 md:py-6 lg:py-8 xl:py-9 2xl:py-[38px] '>
                            <div className='flex-none w-full flex lg:w-[280px] xl:w-[270px] 2xl:w-[514px] items-center sm:border-none'>
                                <Link to={data.link_url}>
                                    <div className='text-[21px] sm:text-2xl md:text-[21px] lg:text-4xl xl:text-4xl font-bold font-Arial hover:text-[#7a6b87]'>
                                        {data.title}
                                    </div>
                                </Link>
