            ...
            {selectionsData && selectionsData.map((data, index) => (
                <div key={data.id} className={`flex flex-col md:flex-row text-white sm:px-0 md:px-0 ${data.id !== 1 ? 'pt-6 lg:pt-8 xl:pt-[60px] 2xl:pt-[2vw]' : 'md:mt-[-40px] lg:mt-[-20px] xl:mt-0'}`}>
                    ...
                    <div className='flex-1 m-0 p-0 border-white border-b-[1px]'>
                        ...
                        <div className='pl-[9px] md:pl-0 flex flex-col 2xl:flex-row font-bold items-start 2xl:items-center py-8 md:py-6 lg:py-8 xl:py-9 2xl:py-[2.5vw]'>
                            <div className='flex-none w-full flex lg:w-[280px] xl:w-[270px] 2xl:w-[20vw] items-center sm:border-none'>
                                <Link to={data.link_url}>
                                    <div className='text-[21px] sm:text-2xl md:text-[21px] lg:text-4xl xl:text-4xl 2xl:text-[2vw] font-bold font-Helvetica hover:text-[#7a6b87] pl-2 md:pl-0'>
                                        {data.title}
                                    </div>
                                </Link>
