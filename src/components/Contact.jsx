...
const Contact = () => {
  return (
    <div className="flex flex-row text-white font-Arial text-lg border-t-[1px] py-10 px-[72px] items-center">
      <div className="basis-1/5">
        <img
          src={Logo}
          alt="logo"
          className="cursor-pointer w-[181.15px] h-[77.48px]"
        />
      </div>
      <div className="basis-1/5">
        <div>Expertise.</div>
        <div className="pt-2">Showcases.</div>
      </div>
      <div className="basis-1/5">
        <div>Get to know us.</div>
        <div className="pt-2">Our Manifesto.</div>
      </div>
      <div className="basis-1/5">
        <div>Our design thinking process.</div>
        <div className="pt-2">Let's talk.</div>
      </div>
      <div className="basis-1/5">
