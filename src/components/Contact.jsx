...
const Contact = () => {
    return (
        <div className='px-[8px] sm:px-6 md:px-[45px] xl:px-[50px] pt-0 xl:pt-8'>
            <div className='relative px-4 sm:px-0 flex flex-col items-center xl:items-stretch border-x-[1px] border-b-[1px] xl:border-none'>
                <div className='absolute h-[1px] block lg:hidden bg-white w-full tom-10 bottom-[230px]'>
                </div>
                <div className='grid lg:grid-cols-5 text-white font-Arial text-lg px-[9px] sm:px-8 lg:px-16 w-full'>
                    <div className='text-start pt-7 lg:pt-3'>
                        <Link to="/home">
                            <img src={Logo} alt="logo" className='cursor-pointer w-[181.15px] h-[77.48px]' />
                        </Link>
                    </div>
                    <div className='grid col-span-3 items-center w-full pl-0 lg:pl-14 xl:pl-0'>
                ...
                <div className='grid grid-cols-1 xl:grid-cols-5 text-white font-Arial text-lg pt-16 xl:pt-10 mx-auto xl:mx-0 px-[9px] sm:px-8 lg:px-16 pb-0 lg:pb-10 w-full lg:w-auto'>
                    <div></div>
                ...
                <div className='px-[9px] sm:px-8 sm:py-4 md:py-4 lg:py-5 xl:py-0 flex gap-7 justify-start w-full lg:hidden text-white pb-8 lg:pb-0'>
                    ...
                    <div className='flex gap-10 py-2 xl:mt-0 items-center'>
                        <svg width="29" height="28" viewBox="0 0 29 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path id="Vector" d="M28.151 7.3239C28.151 3.29248 24.8525 0 20.8272 0H7.47463C3.44321 0 0.150879 3.29858 0.150879 7.3239V20.6767C0.150879 24.702 3.44931 28 7.47463 28H20.8272C24.8586 28 28.151 24.702 28.151 20.6767V7.3239ZM10.9869 20.1023H8.27485V11.3921H10.9869V20.1023ZM9.63085 10.2068C8.76349 10.2068 8.06107 9.50478 8.06107 8.63741C8.06107 7.77004 8.76349 7.06741 9.63085 7.06741C10.4982 7.06741 11.2007 7.77004 11.2007 8.63741C11.2007 9.49867 10.4982 10.2068 9.63085 10.2068ZM21.1326 20.1023H18.4267V15.8695C18.4267 14.8555 18.4084 13.5604 17.0218 13.5604C15.6108 13.5604 15.3971 14.66 15.3971 15.7961V20.1023H12.6911V11.3921H15.2871V12.5833H15.3238C15.6841 11.8992 16.5698 11.1779 17.8892 11.1779C20.6318 11.1779 21.1387 12.9799 21.1387 15.3254V20.1023H21.1326Z" fill="white" />
                        </svg>
                        <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
