        ...
        <div>
            {
                expertiseData2.map((val) => (
                    <div key={val.id} className="text-white border-b-[1px] border-white pl-4 md:pl-0 pt-6 lg:pt-12 xl:pt-[55px] 2xl:pt-[3vw]">
                        <div className="font-Helvetica flex flex-col xl:flex-row justify-between">
                            <div className="xl:max-w-[950px] 2xl:max-w-none">
                                <Link to={val.link_url}>
                                    <div className="flex items-center font-extrabold text-[18px] pr-4 md:text-[35px] lg:text-[40px] xl:text-[44px] 2xl:text-[1.75vw] 3xl:text-[2vw] hover:text-[#7a6b87]">
                                        {val.title}
                                    </div>
                                </Link>
                                <div className="font-normal text-[3.2vw] pr-4 pt-1 sm:text-sm sm:pr-[30px] sm:text-left md:text-base md:pr-[30px] md:text-left md:pt-2 lg:text-lg lg:pt-4 lg:pr-8 lg:pr-4 xl:text-xl xl:pt-[23px] xl:pr-0 2xl:text-[1.05vw] 2xl:pt-[1.05vw] 2xl:pr-[2vw] 2xl:min-h-[3.5vw] 2xl:leading-[1.4vw]">
                                    {val.text}
                                </div>
                            </div>
                        ...
                        <div className="text-[13px] md:text-[1.3vw] xl:text-[0.9vw] font-Helvetica grid grid-cols-1 2xl:grid-cols-1 3xl:grid-cols-2 pr-0 sm:pr-8 xl:pr-[5vw] 2xl:pr-[2.5vw] pt-4 md:pt-[18px] lg:pt-6 xl:pt-[3vw] 2xl:pt-[1.8vw] pb-[5px] lg:pb-[10px] xl:pb-[3vw] 2xl:pb-[1.8vw]">
                                ...
                                <div className="hidden lg:block w-max">
                                    <div className="flex border-t-[1px] border-b-[1px] border-white">
                                        {val.content1.map((content, index) => (
                                            <div
                                                key={content}
                                                className={`py-[0.7vw] pr-[0.7vw] border-white ${index === 0 ? '' : 'border-l pl-[0.7vw]'}`}
                                            >
                                                {content}
                                            </div>
                                        ))}
                                    ...
                                    <div className="flex border-b-[1px] border-white">
                                        {val.content2.map((content, index) => (
                                            <div
                                                key={content}
                                                className={`text-[13px] md:text-[1.3vw] xl:text-[0.9vw] py-[1vw] pr-[1vw] border-white ${val.content2.length !== index + 1 ? 'border-r' : 'pl-[0.1vw]'}`}
                                            >
                                                {content}
                                            </div>
                                        ))}
