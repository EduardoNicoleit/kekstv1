...
const Footer = () => {
    return (
        <div>
            <div className='mx-2 lg:mx-4 xl:mx-[25px] 2xl:mx-[45px] 3xl:mx-[45px]'>
                <div className='px-0 sm:px-6 md:px-8 lg:px-0 relative pt-0 lg:pt-8 2xl:pt-[1.6vw] pb-2 2xl:pb-[2.5vw] 3xl:pb-[1.5vw] flex flex-col items-center xl:items-stretch border-t-[1px] border-white'>
                    ...
                    <div className='pl-6 sm:pl-0 px-0 py-8 lg:py-5 flex justify-left w-full lg:hidden text-white md:mr-0'>
                        {/* Email Link */}
                        <a
